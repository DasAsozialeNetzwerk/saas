...
onMessage server msg
   ...
   | "Open Source" `isIn` msg = do -- TODO: schoenere Loesung finden
   	  hilightSend "The official definition of \"open source software\" (which is published by the Open Source Initiative and is too long to include here) was derived indirectly from our criteria for free software."
	     hilightSend "However, the obvious meaning for the expression \"open source software\"—and the one most people seem to think it means—is \"You can look at the source code.\" That criterion is much weaker than the free software definition, much weaker also than the official definition of open source.  It includes many programs that are neither free nor open source."
	     hilightSend "The terms \"FLOSS\" and \"FOSS\" are used to be neutral between free software and open source. If neutrality is your goal, \"FLOSS\" is the better of the two, since it really is neutral. But if you want to stand up for freedom, using a neutral term isn\'t the way. Standing up for freedom entails showing people your support for freedom."
